...
go test ./test/zerotoken -run '^TestGateAZeroTokenCore$' -count=5
go test -race ./internal/memorystore ./internal/sourcecatalog ./internal/scan ./test/zerotoken -count=1
go test ./... -count=1
go vet ./...
