...
5. **Backup manifest:** Project contained one content-addressed migration manifest covering six legacy files. Every object and archive digest matched its manifest entry (`6` checked, `0` mismatches). Vault contained no migration backup.
