...
- Main remains5c5cb7a with original dirty human documents/prototypes. Installed CLI and NeoMei-Docs plugin hashes remain unchanged. Native Obsidian was read-only inspected and remains at the restricted-mode prompt; permission is pending.
