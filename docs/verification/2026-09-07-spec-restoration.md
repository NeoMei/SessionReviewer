...
| S07 | §7, §13.1/2/12 | Full index, filters, retained unavailable sources, summary/search/paged events | Local filters/navigation/state restored at6010623 with clean scoped review and browser checks; private search/provider/native integration still open; blocking |
...
| S11 | §13.11 | Enabled providers use same index/drilldown/status experience | Generic memory provider contracts reviewed at01218cb+cf81296; actual Claude/OpenCode adapters, complete discovery, source coordinates and frontend parity remain missing; blocking |
