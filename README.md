...
Download `main.js`, `manifest.json`, and `styles.css` from [GitHub Release 0.2.4](https://github.com/NeoMei/SessionReviewer/releases/tag/0.2.4). Place the three files in:
