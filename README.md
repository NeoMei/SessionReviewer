...
Download `main.js`, `manifest.json`, and `styles.css` from [GitHub Release 0.3.2](https://github.com/NeoMei/SessionReviewer/releases/tag/0.3.2). Place the three files in:
