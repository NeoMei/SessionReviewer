import { normalizeSessionBrowserState, type SessionBrowserState } from "./session-browser-state";
...
export type V4ViewStatePatch = Partial<Omit<V4ViewState, "projectId">>;
...
export function normalizeV4ViewState(value: unknown, projectId: string): V4ViewState {
  const fallback: V4ViewState = {
    ...
    sessionBrowser: normalizeSessionBrowserState(undefined)
  };
  ...
  return {
    ...
    sessionBrowser: normalizeSessionBrowserState(value.sessionBrowser)
  };
}
