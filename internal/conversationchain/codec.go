...
func normalize(document *Document) {
	if document.DependencyProofV1 != nil {
		if document.DependencyProofV1.VisibleRecords == nil {
			document.DependencyProofV1.VisibleRecords = []DependencyRecordProofV1{}
		}
		if document.DependencyProofV1.ActiveRevisionIDs == nil {
			document.DependencyProofV1.ActiveRevisionIDs = []string{}
		}
	}
