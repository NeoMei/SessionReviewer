...
func TestProjectMilestonesQualifiesOnlyClosedMachineEvidence(t *testing.T) {
	tests := []struct {
		...
		{name: "explicit passed false", messages: milestoneMessages("test it", "not passed"), facts: []milestoneFactSpec{{kind: "verification", operation: "verification", outcome: "passed", line: 2, timestamp: milestoneTime2, fields: map[string]string{"exit_code": "0", "passed": "false", "failed": "false"}}}},
		{name: "explicit passed zero", messages: milestoneMessages("test it", "none passed"), facts: []milestoneFactSpec{{kind: "verification", operation: "verification", outcome: "passed", line: 2, timestamp: milestoneTime2, fields: map[string]string{"exit_code": "0", "passed": "0", "failed": "false"}}}},
